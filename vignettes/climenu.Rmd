...
`climenu` relies on the `keypress` package (installed automatically) for single-keypress capture. If arrow keys still don't respond, your terminal may not be recognized as interactive — try running from a standard terminal emulator or the RStudio console rather than a non-TTY environment.
